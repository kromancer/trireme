...
int main(int argc, char **argv) {
    ...
    struct shm_info mat_data = open_and_map_shm(argv[5], true);
    struct shm_info mat_indptr = open_and_map_shm(argv[6], true);
    struct shm_info mat_indices = open_and_map_shm(argv[7], true);
