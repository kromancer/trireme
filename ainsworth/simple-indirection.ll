; ModuleID = 'simple-indirection.c'
source_filename = "simple-indirection.c"
target datalayout = "e-m:o-p:32:32-Fi8-f64:32:64-v64:32:64-v128:32:128-a:0:32-n32-S32"
target triple = "armv4t-apple-macosx10.19.0"

; Function Attrs: noinline nounwind ssp
define void @compute(i32* noalias %key_buff1, i32* noalias %key_buff2, i32 %num_keys) #0 {
entry:
  %key_buff1.addr = alloca i32*, align 4
  %key_buff2.addr = alloca i32*, align 4
  %num_keys.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32* %key_buff1, i32** %key_buff1.addr, align 4
  store i32* %key_buff2, i32** %key_buff2.addr, align 4
  store i32 %num_keys, i32* %num_keys.addr, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i32, i32* %i, align 4
  %1 = load i32, i32* %num_keys.addr, align 4
  %cmp = icmp slt i32 %0, %1
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %2 = load i32*, i32** %key_buff1.addr, align 4
  %3 = load i32*, i32** %key_buff2.addr, align 4
  %4 = load i32, i32* %i, align 4
  %arrayidx = getelementptr inbounds i32, i32* %3, i32 %4
  %5 = load i32, i32* %arrayidx, align 4
  %arrayidx1 = getelementptr inbounds i32, i32* %2, i32 %5
  %6 = load i32, i32* %arrayidx1, align 4
  call void @some_function(i32 %6)
  br label %for.inc
...
declare void @some_function(i32) #1
