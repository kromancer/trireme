...
for.cond1:                                        ; preds = %for.inc, %for.body
  %tja_val.0 = phi double [ 0.000000e+00, %for.body ], [ %add8, %for.inc ]
  %jB.0 = phi i32 [ %0, %for.body ], [ %inc, %for.inc ]
...
for.body4:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds i32, i32* %crd, i32 %jB.0
  %2 = load i32, i32* %arrayidx5, align 4
  %arrayidx6 = getelementptr inbounds double, double* %B_vals, i32 %jB.0
  %3 = load double, double* %arrayidx6, align 4
  %arrayidx7 = getelementptr inbounds double, double* %c_vals, i32 %2
  %4 = load double, double* %arrayidx7, align 4
  %mul = fmul double %3, %4
  %add8 = fadd double %tja_val.0, %mul
  br label %for.inc

for.inc:                                          ; preds = %for.body4
  %inc = add nsw i32 %jB.0, 1
  br label %for.cond1

for.end:                                          ; preds = %for.cond1
  %arrayidx9 = getelementptr inbounds double, double* %a_vals, i32 %i.0
  store double %tja_val.0, double* %arrayidx9, align 4
  br label %for.inc10
