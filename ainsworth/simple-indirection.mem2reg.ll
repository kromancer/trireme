...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %cmp = icmp slt i32 %i.0, %num_keys
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond

  ; load key_buff2[i]
  %arrayidx = getelementptr inbounds i32, i32* %key_buff2, i32 %i.0
  %0 = load i32, i32* %arrayidx, align 4

  ; load key_buff1[key_buff2[i]]
  %arrayidx1 = getelementptr inbounds i32, i32* %key_buff1, i32 %0
  %1 = load i32, i32* %arrayidx1, align 4
  
  ; call some_function(key_buff1[key_buff2[i]])
  call void @some_function(i32 %1)
